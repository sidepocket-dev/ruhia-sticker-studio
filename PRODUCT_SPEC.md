...
### 実測：コラージュ禁止だけでは足りなかった

**最初の文面は失敗した。** 「1枚にまとめない」を冒頭と末尾で言っただけでは、
**同じシートが重複して2枚しか返らなかった。**

追加検証の結果、次の2つを入れると1回の依頼で5枚生成できた。
...
```text
5枚生成できなかった / 同じシートが重複した / シートの内容が混ざった
```
